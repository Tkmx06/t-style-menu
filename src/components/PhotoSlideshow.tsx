...
// 5列で常に自動スクロールし続け、その上を料理名の吹き出しが次々と浮かび上がって
// は消えていく演出に変更しました(参考: jra-fun.jp/umajob の「写真の壁+浮かび
// 上がるコメント」演出)。手動送りの矢印・ドットは不要になったため廃止しています。
//
// データの取得元・件数・並び順(page.tsx側のgetSlideshowDishes、公開中の全カテゴリ
// からランダム抽出)や、コンポーネントのprops("dishes"のみ)は変更していません。
